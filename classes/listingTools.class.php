	...
	class listingTools {
		...
		public function renderRunningListings($orderBy, $inOrder, $limit) {
			...
			if ($result->num_rows == 0) {
				...
				$output .= "<tr><td colspan='3'><center><strong>There are currently no listings :( - Start a trend and <a href='createListing.php'>create a new listing</a> or check back later!</strong></center></td></tr>";
